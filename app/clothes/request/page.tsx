...
import { clothesSection } from '@/data/dummy-donations';
import { FilterOptions, DonationItem } from '@/types/donations';
import { toast } from 'sonner';

export default function ClothesRequestPage() {
  ...
  const filteredItems = useMemo(() => {
    let items = clothesSection.items;
  ...
  const handleDonateSimilar = async (itemId: string) => {
    ...
    window.location.href = '/clothes/donate';
  };
        ...
        <div className="container mx-auto px-4 py-12">
          ...
          <div className="text-center mb-12">
            ...
            >
              ...
              <h1 className="text-4xl font-bold text-gray-900">Request Clothes</h1>
            </motion.div>
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Browse available clothing donations and request items that you or your family need. All items are completely free.
            </p>
          </div>
            ...
            <Card className="border-2 border-primary/20 shadow-lg">
              <CardContent className="pt-6 text-center space-y-6">
                ...
                <p className="text-gray-600">
                  To request clothing items, you need to be logged in as a recipient. This helps us ensure fair distribution and maintain the quality of our service.
                </p>
                
                <div className="bg-blue-50 p-4 rounded-lg border border-blue-200">
                  <h4 className="font-semibold text-blue-900 mb-2">Why do we need authentication?</h4>
                  <ul className="text-sm text-blue-800 space-y-1 text-left">
                    <li>• Ensures fair distribution of items</li>
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  ...
                  <Button asChild variant="outline" size="lg">
                    <Link href="/clothes/donate">
                      <Shirt className="h-5 w-5 mr-2" />
                      Donate Clothes Instead
                    </Link>
                  </Button>
                </div>
              </CardContent>
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
              {clothesSection.items.slice(0, 6).map((item) => (
                <DonationCard
                  key={item.id}
                  item={item}
            ...
            <div className="text-center mt-8">
              <p className="text-gray-600 mb-4">
                Sign up to see all available items and request what you need
              </p>
              <Button asChild size="lg" className="bg-primary hover:bg-primary/90">
                <Link href="/auth/login">
                  <Heart className="h-5 w-5 mr-2" />
          ...
          >
            <Card className="border-2 border-orange-200 shadow-lg">
              <CardContent className="pt-6 text-center space-y-6">
                ...
                <p className="text-gray-600">
                  You're currently logged in as a donor. To request clothing items, you need to switch to recipient mode or create a recipient account.
                </p>
          ...
          {filteredItems.length === 0 ? (
            <Card className="max-w-2xl mx-auto">
              <CardContent className="pt-6 text-center">
                ...
                <p className="text-gray-600 mb-6">
                  Try adjusting your filters or search terms to find more clothing items.
                </p>
            ...
            <>
              <div className="flex items-center justify-between mb-6">
                <p className="text-gray-600">
                  Showing {filteredItems.length} of {clothesSection.items.length} clothing items
                </p>
                <div className="flex items-center gap-2">
                  <Badge variant="secondary" className="bg-green-100 text-green-800">
                    <Clock className="h-3 w-3 mr-1" />
                    {clothesSection.availableItems} Available
                  </Badge>
                  <Badge variant="secondary" className="bg-red-100 text-red-800">
                    <AlertCircle className="h-3 w-3 mr-1" />
                    {clothesSection.highDemandItems} High Demand
                  </Badge>
                </div>
              </div>
        ...
        >
          <Card className="max-w-2xl mx-auto bg-primary/5 border-primary/20">
            <CardContent className="pt-6">
              ...
              <p className="text-gray-600 mb-6">
                If you can't find the clothing items you need, consider donating similar items to help others in your community.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Button asChild size="lg" className="bg-primary hover:bg-primary/90">
                  <Link href="/clothes/donate">
